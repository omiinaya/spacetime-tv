...
import { Skeleton, SeriesCardSkeleton, TabSkeleton } from "@/components/Skeleton";
...
export default function SeriesPage() {
  ...
  const { visibleItems, sentinelRef, hasMore } = useInfiniteScroll(series, BATCH);
  ...
  return (
    <div className="space-y-6">
      ...
      {series.length === 0 && !listLoading && !loading && (
