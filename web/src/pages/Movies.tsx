...
import { Skeleton, PosterCardSkeleton, TabSkeleton } from "@/components/Skeleton";
...
export default function Movies() {
  ...
  const { visibleItems, sentinelRef, hasMore } = useInfiniteScroll(movies, BATCH);
  ...
  return (
    <div className="space-y-6">
      ...
      {movies.length === 0 && !listLoading && !loading && (
