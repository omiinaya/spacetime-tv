...
describe("SeriesSearchInput", () => {
  it("renders an input with the default placeholder", () => {
    render(<SeriesSearchInput value="" onChange={() => {}} />);
  ...
  it("displays the current value in the input", () => {
    render(<SeriesSearchInput value="Star Trek" onChange={() => {}} />);
  ...
  it("calls onChange when the user types", () => {
    ...
    render(<SeriesSearchInput value="" onChange={onChange} />);
  ...
  it("shows a clear X button when value is non-empty", () => {
    render(<SeriesSearchInput value="Star" onChange={() => {}} />);
  ...
  it("clears the input when the X button is clicked", () => {
    const onChange = vi.fn();
    render(<SeriesSearchInput value="Star" onChange={onChange} />);
