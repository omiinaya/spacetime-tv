...
describe("useSearchPage", () => {
  ...
  it("handleQueryChange updates query and triggers search after debounce", async () => {
    mockSearch.mockResolvedValue(makeSearchResults({
      live: [{ stream_id: 1, name: "CNN", category_id: "1", num: 0, stream_type: "live", stream_icon: "", epg_channel_id: "", added: "", is_adult: 0, category_ids: ["1"], custom_sid: null, tv_archive: 0, direct_source: "", tv_archive_duration: 0 }],
    }));
  ...
  it("filter returns only live results when filter='live'", () => {
    ...
    mockSearch.mockResolvedValue(makeSearchResults({
      live: [], movies: [{ stream_id: 1, name: "Movie A", category_id: "1", num: 0, stream_type: "movie", stream_icon: "", added: "", is_adult: 0, category_ids: ["1"], custom_sid: null, direct_source: "", container_extension: "mp4", rating: "", tmdb: null }],
      series: [],
    }));
    mockGuideSearch.mockResolvedValue({ results: [] });
  ...
  it("loadMore fetches next page and merges results", async () => {
    ...
    mockSearch.mockResolvedValue(makeSearchResults({
      live: [
        { stream_id: 1, name: "CNN", category_id: "1", num: 0, stream_type: "live", stream_icon: "", epg_channel_id: "", added: "", is_adult: 0, category_ids: ["1"], custom_sid: null, tv_archive: 0, direct_source: "", tv_archive_duration: 0 },
        { stream_id: 2, name: "BBC", category_id: "2", num: 0, stream_type: "live", stream_icon: "", epg_channel_id: "", added: "", is_adult: 0, category_ids: ["2"], custom_sid: null, tv_archive: 0, direct_source: "", tv_archive_duration: 0 },
      ],
    }));
    mockGuideSearch.mockResolvedValue({ results: [] });
    ...
    mockSearch.mockResolvedValue(makeSearchResults({
      live: [
        { stream_id: 3, name: "NBC", category_id: "3", num: 0, stream_type: "live", stream_icon: "", epg_channel_id: "", added: "", is_adult: 0, category_ids: ["3"], custom_sid: null, tv_archive: 0, direct_source: "", tv_archive_duration: 0 },
      ],
    }));
    ...
    expect(result.current.results?.live.map((s) => s.name)).toEqual(["CNN", "BBC", "NBC"]);
  });
  ...
  it("loadMore does nothing while already loading", async () => {
    ...
    mockSearch.mockImplementation(async () => {
      ...
      return makeSearchResults({ live: [{ stream_id: 2, name: "BBC", category_id: "2", num: 0, stream_type: "live", stream_icon: "", epg_channel_id: "", added: "", is_adult: 0, category_ids: ["2"], custom_sid: null, tv_archive: 0, direct_source: "", tv_archive_duration: 0 }] });
    });
  ...
  it("computes total from all sections", async () => {
    mockSearch.mockResolvedValue(makeSearchResults({
      live: Array.from({ length: 3 }, (_, i): any => ({ stream_id: i, name: `Live ${i}`, category_id: "1", num: 0, stream_type: "live", stream_icon: "", epg_channel_id: "", added: "", is_adult: 0, category_ids: ["1"], custom_sid: null, tv_archive: 0, direct_source: "", tv_archive_duration: 0 })),
      movies: Array.from({ length: 2 }, (_, i): any => ({ stream_id: i + 10, name: `Movie ${i}`, category_id: "1", num: 0, stream_type: "movie", stream_icon: "", added: "", is_adult: 0, category_ids: ["1"], custom_sid: null, direct_source: "", container_extension: "mp4", rating: "", tmdb: null })),
      series: [],
    }));
    mockGuideSearch.mockResolvedValue({ results: [] });
